...
class UserController extends Controller
{
	...
	public function userRoleAdd()
	{
		...
		$data['role'] = array(
			array(
				'clients' => $data['lang']['users']['text_client_list'],
				'clients/add' => $data['lang']['users']['text_client_add'],
				'client/edit' => $data['lang']['users']['text_client_edit'],
				'client/delete' => $data['lang']['users']['text_client_delete'],
				'client/view' => $data['lang']['users']['text_client_view'],
			),

			array(
				'companies' => $data['lang']['users']['text_company_list'],
				'company/add' => $data['lang']['users']['text_company_add'],
				'company/edit' => $data['lang']['users']['text_company_edit'],
				'company/delete' => $data['lang']['users']['text_company_delete'],
				'company/view' => $data['lang']['users']['text_company_view'],
			),

			array(
				'contacts' => $data['lang']['users']['text_contact_list'],
			...
			array(
				'domains' => $data['lang']['users']['text_domain_list'],
			...
			array(
				'expenses' => $data['lang']['users']['text_expense_list'],
			...
			array(
				'employees' => $data['lang']['users']['text_employee_list'],
				'employee/add' => $data['lang']['users']['text_employee_add'],
				'employee/edit' => $data['lang']['users']['text_employee_edit'],
				'employee/delete' => $data['lang']['users']['text_employee_delete'],
				'employee/view' => $data['lang']['users']['text_employee_view']
			),
			
			array(
				'inventory' => $data['lang']['users']['text_inventory_list'],
				'inventory/add' => $data['lang']['users']['text_inventory_add'],
				'inventory/edit' => $data['lang']['users']['text_inventory_edit'],
				'inventory/delete' => $data['lang']['users']['text_inventory_delete'],
				'inventory/view' => $data['lang']['users']['text_inventory_view'],
			),

			array(
				'invoices' => $data['lang']['users']['text_invoice_list'],
			...
			array(
				'leads' => $data['lang']['users']['text_lead_list'],
			...
			array(
				'quotes' => $data['lang']['users']['text_quote_list'],
			...
			array(
				'recurring' => $data['lang']['users']['text_recurring_invoice_list'],
			...
			array(
				'subscriber' => $data['lang']['users']['text_subscriber_list'],
			...
			array(
				'tickets' => $data['lang']['users']['text_ticket_list'],
			...
			array(
				'users' => $data['lang']['users']['text_user_list'],
