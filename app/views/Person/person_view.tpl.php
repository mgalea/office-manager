            ...
            <div class="panel-body">
                <div class="user-details text-center">
                    ...
                    <ul class="nav flex-column vnav-tabs text-left">
                        ...
                        <?php  if(isset($result['contact_type'])&&(int)$result['contact_type']>2){  ?>
                        <li class="nav-item">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <p class="mb-1"><span class="font-500"><?php echo $lang['person']['text_pincode'] ?> </span> : <?php echo $result['address']['pin']; ?></p>
                                <p class="mb-1"><span class="font-500"><?php echo $lang['common']['text_phone_number'] ?></span> : <?php echo $result['address']['phone1']; ?></p>
                            </div>
                        </div>
                        <h5 class="font-500 font-20 text-green mt-3"><?php echo $lang['person']['text_contact_persons']; ?></h5>
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php if (isset($result['persons'])) { foreach ($result['persons'] as $key => $value) { ?>
                                    <tr>
                        ...
                        <h5 class="font-500 font-20 text-green mt-4"><?php echo $lang['person']['text_remark']; ?></h5>
