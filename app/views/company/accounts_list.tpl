    ...
    <div class="panel panel-default">
        <div class="panel-head">
            ...
            <div class="panel-action">
                ...
                <a href="<?php echo URL . DIR_ROUTE . 'company/add'; ?>" class="btn btn-success btn-sm"><i class="icon-plus mr-1"></i> <?php echo $lang['bank']['text_new_account']; ?></a>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php if ($result) {
                            foreach ($result as $key => $value) { ?>
                                ...
                                <tr>
                                    <td><a href="<?php echo URL . DIR_ROUTE . 'company/view&id=' . $value['id']; ?>"><?php echo $value['account_name']; ?></td>
                                    <td><a href="<?php echo URL . DIR_ROUTE . 'company/view&id=' . $value['id']; ?>"><?php echo $value['account_number']; ?></td>
                                    <td><a href="<?php echo URL . DIR_ROUTE . 'company/view&id=' . $value['id']; ?>"><?php echo $value['company']; ?></a></td>
                                    <td><a href="<?php echo URL . DIR_ROUTE . 'company/view&id=' . $value['id']; ?>"><?php echo $value['bank']; ?></a></td>
