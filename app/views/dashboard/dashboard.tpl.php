...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-lg-6 mb-3">
            ...
            <div class="row">
                <?php include(DIR . 'app/views/widgets/total_income_year.tpl.php'); ?>
                <?php include(DIR . 'app/views/widgets/total_expense_year.tpl.php'); ?>
                <?php include(DIR . 'app/views/widgets/top_subsidiary_income.tpl.php'); ?>
            </div>
        </div>
    </div>
