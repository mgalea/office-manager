                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="table-action">
                            ...
                            <a href="<?php echo URL.DIR_ROUTE . 'invoice/edit&id=' .$value['id']; ?>" class="btn btn-info btn-circle btn-outline btn-outline-1x" data-toggle="tooltip" title="<?php echo $lang['common']['text_edit']; ?>"><i class="icon-pencil"></i></a>
