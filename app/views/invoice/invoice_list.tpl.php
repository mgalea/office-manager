                        ...
                        foreach ($result as $key => $value) { ?>
                            <tr>
                                ...
                                <td class="table-action">
                                    <a target="_blank" href="<?php echo URL . DIR_ROUTE . 'invoice/view&id=' . $value['id']; ?>" class="btn btn-success mr-2" data-toggle="tooltip" title="<?php echo $lang['common']['text_view']; ?>"><i class="fa fa-eye"></i></a>
                                    <a target="_blank" href="<?php echo URL . DIR_ROUTE . 'invoice/edit&id=' . $value['id']; ?>" class="btn btn-primary text-info  mr-2" data-toggle="tooltip" title="<?php echo $lang['common']['text_edit']; ?>"><i class="icon-pencil"></i></a>
