	...
	<div class="panel panel-default">
		<div class="panel-head">
			...
			<div class="panel-action">
				<a href="<?php echo URL.DIR_ROUTE . 'subscriber/add'; ?>" class="btn btn-success btn-sm"><i class="icon-plus mr-1"></i> <?php echo $lang['users']['text_new_subscriber']; ?></a>
			</div>
		</div>
					...
					<tbody>
						...
						<tr>
							...
							<td class="table-action">
								<a href="index.php?route=subscriber/edit&id=<?php echo $value['id']; ?>" class="btn btn-info btn-circle btn-outline btn-outline-1x" data-toggle="tooltip" title="<?php echo $lang['common']['text_edit']; ?>"><i class="icon-pencil"></i></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form action="index.php?route=subscriber/delete" class="delete-card-button" method="post">
