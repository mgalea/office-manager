...
<div class="panel panel-default">
	<div class="row separator">
		<div class="col-md-4">
			<div class="widget1">
				<a href="<?php echo URL_CLIENTS . DIR_ROUTE . 'invoices'; ?>">
		...
		<div class="col-md-4">
			<div class="widget1">
				<a href="<?php echo URL_CLIENTS . DIR_ROUTE . 'quotes'; ?>">
					<div class="row m-0 align-items-center">
						<div class="col-auto">
		...
		<div class="col-md-4">
			<div class="widget1">
				<a href="<?php echo URL_CLIENTS . DIR_ROUTE . 'tickets'; ?>">
					<div class="row m-0 align-items-center">
	...
	<div class="row separator">
		<div class="col-md-3">
			<div class="widget1">
				...
				<div id="status-chart" style="height: 180px;">
					<?php

					echo '</br>';
					foreach ($invoice_status as $inv) {
						foreach ($inv as $k => $v) {
							echo $v . ' ';
						}
						echo '</br>';
						...
						<div class="card card-color-new">
							...
							<div class="row card-ftr align-items-center">
								<div class="col-sm-8 text-left">
									...
									<span class="badge badge-default badge-pill badge-sm"><?php if ($lastticket['status'] == "1") {
																								echo $lang['dashboard']['text_closed'];
																							} else {
																								echo $lang['dashboard']['text_open'];
																							} ?></span>
								</div>
